...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    WORDS = 277,                   // "words"
    LINES = 278,                   // "lines"
    DOCUMENTS = 279,               // "documents"
    EXPRESSION = 280,              // "expression"
    TEXT = 281,                    // TEXT
    NUMBER = 282,                  // NUMBER
    FLOAT = 283,                   // FLOAT
    DELIMITER = 284,               // DELIMITER
    SYMBOL = 285,                  // SYMBOL
    EMPTY = 286,                   // EMPTY
    DERIVED = 287                  // DERIVED
      };
...
#line 1983 "/home/marek/Desktop/Skola/dp/ebe/frontend/parser_ebel.hpp"
